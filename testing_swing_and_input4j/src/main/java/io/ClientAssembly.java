...
public class ClientAssembly 
{
    ...
    public static Framework app_generate_Program()
    {
        ...
        //stat_CLASS_get_Framework().dyn_REG_get_Item_InputPeripheralSampled_Data().();//todo
        //stat_CLASS_get_Framework().dyn_REG_get_Item_InputPeripheralSampled_Data().();//todo
        //stat_CLASS_get_Framework().dyn_REG_get_Item_InputPeripheralSampled_Data().();//todo
        ...
        System.out.printf("started independent STRUCT User_Algorithim() - DECLAIRE, DEFINE INITIALISE, Registers - DEFINE, SUBSTANTIATE, INITIALISE.%n");
        ...
        System.out.printf("done independent STRUCT User_Algorithim() - DECLAIRE, DEFINE INITIALISE, Registers - DEFINE, SUBSTANTIATE, INITIALISE.%n");
        ...
        System.out.printf("started independent STRUCT Algorithim(() - DECLAIRE, DEFINE INITIALISE, Registers - DEFINE, SUBSTANTIATE, INITIALISE.%n");
        ...
        System.out.printf("done independent STRUCT Algorithim(() - DECLAIRE, DEFINE INITIALISE, Registers - DEFINE, SUBSTANTIATE, INITIALISE.%n");
